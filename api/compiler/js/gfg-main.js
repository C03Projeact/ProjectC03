...
$(document).ready(function () {
	...
	$('#addTab').click(function () {
		...
		$('div#tab' + currentTab + ' > .closeTab').css({
			'background-color': '#ffffff'
		});
	...
	function displayResult(this1, data) {
		...
		$("html, body").animate({
			scrollTop: $(".sbt-group").offset().top + 60
		}, "slow");
	...
	$("#submit-code").click(async () => {
		...
		await fetch(`https://rmuttcpethesis.com/ProjectC03/api/compiler/api/submit.php`, requestOptions)
