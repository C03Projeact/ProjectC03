  ...
  const handleStudentSubmit = (event) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        clearForm();
        console.log("Navigating to /admin-student"); // เพิ่ม log เพื่อตรวจสอบ
        navigate("/admin-student"); // Redirect to the admin-teacher page after successful submission
      })
      .catch((error) => {
...
export default AdminAddUserStudent;
