  ...
  return (
    <div className="main-content">
      <div>
        ...
        >
          <AdminItems tolink="/admin-adduser-teacher" item="เพิ่มบัญชีผู้ใช้งาน" />
        </ul>
      </div>
      <br></br>
      <div>
        ...
        >
          ...
          <tbody>
            {accounts.teacher.map((account, index) => (
              <tr key={`teacher_${index}`}>
                ...
                <td style={styles.tableCell}>{account.position}</td>
                <td style={styles.tableCell}>{account.section}</td>
                <td style={styles.tableCell}>
                  <Link
                    to={`/user/teacher/${account.id}/edit`}
